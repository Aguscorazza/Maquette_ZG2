...
from PyQt5.QtWidgets import QApplication,QComboBox,QVBoxLayout,QCheckBox,QHBoxLayout,QPushButton,QLabel,QFrame,QMainWindow,QLineEdit,QFileDialog,QDesktopWidget
...
class MainWindow(QMainWindow):
    ...
    def UIComponents(self):
        ...
        self.Te = 0 # fréquence d'aqquisition
        ...
        self.moteur = 0 # 0 Auto, 1 manuel
        self.kp = 0 # Kp PID
        self.ki = 0 # Ki PID
        self.kd = 0 # Kd PID
        self.vitesse_tour_min = 0 # Consigne de vitesse du moteur mode manuel
        self.duree_acquisition = 0 # Temps de simulation
        ...
        self.graph.plotItem.setLabel("bottom","temps (ms)")
        pen=mkPen('g', width=2)
    ...
    def frame_moteur(self):
        ...
        self.liste_mode_vitesse = QLabel(self)
        self.liste_mode_vitesse.setText("Manuel")
        ...
        self.liste_mode_vitesse.setEnabled(True)

        self.zone_label_vitesse_moteur = QHBoxLayout()
        self.label_vitesse_texte = QLabel()
        self.label_vitesse_texte.setText("Vitesse tr/min (30 à 150):")
        self.edit_vitesse = QLineEdit("80")
    ...
    def frame_parametre(self):
        ...
        self.zone_label_Te = QHBoxLayout()
        self.label_Te_texte = QLabel()
        self.label_Te_texte.setText("Période d'aquisition (ms) :")
        self.line_edit_Te = QLineEdit("20")
        self.zone_label_Te.addWidget(self.label_Te_texte)
        self.zone_label_Te.addWidget(self.line_edit_Te)
        self.zone_label_Te.setAlignment(Qt.AlignLeft)

        self.zone_label_temps_simu = QHBoxLayout()
        self.label_temps_simu_texte = QLabel()
        self.label_temps_simu_texte.setText("Durée d'acqusition (s) :")
        ...
        self.line_edit_kp = QLineEdit("20")
        ...
        self.line_edit_ki = QLineEdit("0.001")
        ...
        self.line_edit_kd = QLineEdit("10")
        ...
        self.intern_frame_parametrage.addLayout(self.zone_label_Te)
    ...
    def setVisibilityParameters(self,bool):
        ...
        self.line_edit_Te.setEnabled(bool)      
    ...
    def enabledAcquistion(self):
        ...
        self.Te = str(self.line_edit_Te.text()) # fréquence d'aqquisition
        ...
        self.vitesse_tour_min = str(self.edit_vitesse.text()) # Consigne de vitesse du moteur mode manuel
        self.duree_acquisition = str(self.line_edit_temps_simu.text()) # Temps de simulation
    ...
    def writeData(self):
        ...
        msg ="{},{},{},{},{},{},{},{},{}/".format(int(self.Te),int(self.state_acq),int(self.state_mode_oscil),
                                                             int(self.moteur),float(self.kp),float(self.ki),float(self.kd),
                                                             int(self.vitesse_tour_min),int(self.duree_acquisition))
        print(msg)
    ...
    def createFile(self):
        entetes = ["Temps","Position","Vitesse Moteur","Fréquence aquisition", "Temps de simulation","Kp","Ki","Kd","consigne vitesse moteur","consigne vitesse min","consigne vitesse max","Nombre de pallier"]
        print("File create")
        #print(str(self.data))
        try :
            ligne = [str(self.data_time[0]),str(self.data_cpt[0]),str(self.data_rpm[0]),str(self.Te),str(self.duree_acquisition),str(self.kp),str(self.ki),str(self.kd),str(self.vitesse_tour_min),
                     str(self.min_vitesse_tour_min),str(self.max_vitesse_tour_min),str(self.nb_pas)]
        except:
